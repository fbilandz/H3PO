...
from selection_sane import *


def plotMassDist(fname,oFile,processLabel="signal",eventsToRead=None, n_of_tagged_jet=0):
    n_of_tagged_jet = int(n_of_tagged_jet)
    good_boosted, total_events = data_boosted_sane(fname,oFile,processLabel="JetHT_BACKGROUND",eventsToRead=None, n_of_tagged_jets=n_of_tagged_jet)
    ...
    return events_total, j3_hist, j2_hist, mjj12_vs_mjjj, mjj13_vs_mjjj, mjj23_vs_mjjj, mjjall_vs_mjjj_signal, j1_pNet, j2_pNet, j3_pNet, j1_mass_hist, j2_mass_hist, j3_mass_hist
...
def create_root_files(year="2017", sample="QCD2000", file="", file_path="", n_of_tagged_jets=0):
    events_total, j3_hist, j2_hist, mjj12_vs_mjjj, mjj13_vs_mjjj, mjj23_vs_mjjj, mjjall_vs_mjjj_signal, j1_pNet, j2_pNet, j3_pNet, j1_mass_hist, j2_mass_hist, j3_mass_hist = plotMassDist(file_path, "{0}-{1}".format(sample, file), processLabel=sample, eventsToRead=None, n_of_tagged_jet=n_of_tagged_jets)
    
    with uproot.recreate("{0}-{1}.root".format(sample, file)) as fout:
        fout[f"total_events"] = events_total
