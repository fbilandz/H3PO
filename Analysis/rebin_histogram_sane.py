...
def rebin_histograms(n_of_tagged_jets=0):
    QCDFile = ROOT.TFile.Open("background/scaled/QCD17_sane.root", "UPDATE")
    TTbarFile = ROOT.TFile.Open("background/scaled/TTbar17_sane.root","UPDATE")
    # SignalFile = ROOT.TFile.Open("signal/scaled/XToHY_6b_2000_1100_sane.root".format(n_of_tagged_jets) ,"UPDATE")
    JetHTFile = ROOT.TFile.Open("background/scaled/JetHT17_sane.root","UPDATE")
